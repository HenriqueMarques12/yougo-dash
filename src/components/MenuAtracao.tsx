...
const Menu: React.FC = () => {
    ...
    const menuData: Bolo[] = [
        {
            img: "Guirlandaredvelvet.jpeg" ,
            title: "Guirlanda Red Velvet",
            desc: "Massa com iogurte natural em tom avermelhado veludo com sabor de cacau, cobertura de leite Ninho e decoração natalina, 22cm. 12 a 15 fatias.",
            price: "R$75,00",
        },

        {
           img: "Guirlandalaranja.jpeg" ,
           title: "Guirlanda de Laranja",
           desc: "Massa aerada e fofinha com suco laranja natural e leite Ninho e cobertura de mousse cremoso de Limão e decoração natalina, 22cm. 12 a 15 fatias.",
           price: "R$65,00",
        },
       /*  {
            img: "/laranja.jpeg" ,
      ...
      /*   {
       ...
       /*  {
        ...
        {
            img: "Guirlandachocolate-brigadeiro.jpeg" ,
            title: "Guilanda de Chocolate",
            desc: "Feito com cacau, massa amanteigada, Cobertura de cacau 100% e decoracao natalina 22cm. 12 a 15 fatias.",
            price: "R$80,00",
        },
 ...
 */
      ...
      /*   {
        ...
        {
            img: "Guirlandacenoura.jpeg" ,
            title: "Guirlanda de Cenoura",
            desc: "Massa deliciosa, feita com iogurt natural, leite Ninho e cenouras frescas. Com uma deliciosa cobertura de cacau 100% e decoração natalina. 22cm. 12 a 15 fatias.",
            price: "R$70,00",
        }, 
 ...
 */
        ...
        const handleVerBolo = (item: Bolo) => {
            setVerBolo(item);
            let divVerBolo:any = document.getElementById("cardapioAtracao");
  ...
  return (
    ...
    >
        <div  id="cardapioAtracao"  className='space-y-4 w-fit mx-auto text-center'>
            <h2 className='text-4xl md:text-6xl font-bold'>
                Nossas <span className='text-accent'> Guirlandas</span>
            </h2>
