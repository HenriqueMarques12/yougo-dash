      ...
      <div className="max-w-sm mx-auto text-white px-1 py-6">
        ...
        >
          ...
          <div className="mb-5">
            ...
            {errors.nome?.message && (
              <p className='text-sm text-red'>{errors.nome.message}</p>
            )}
          </div>
          <div className="mb-5">
            ...
            />
            {errors.dataNascimento?.message && <p className="text-sm text-red">{errors.dataNascimento.message}</p>}
          </div>
          ...
          <div className="mb-5">
            ...
            />
            {errors.cpf?.message && <p className="text-sm text-red">{errors.cpf.message}</p>}
          </div>
          ...
          <div className="mb-5">
            ...
            />
            {errors.telefone?.message && <p className="text-sm text-red">{errors.telefone.message}</p>}
          </div>
          ...
          <div className="mb-5">
            ...
            {errors.plano?.message && (
              <p className="text-sm text-red mt-1">{errors.plano.message}</p>
            )}
          </div>
